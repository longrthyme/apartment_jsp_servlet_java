          ...
          <div class="profile-header">
            <div class="row align-items-center">
              ...
              <div class="col ml-md-n2 profile-user-info">
                <h4 id="profile-name" class="user-name mb-3">Nguyễn Chí Sơn</h4>
                <h6 id="profile-role" class="text-muted mt-1">Quản trị viên</h6>
                <div id="profile-location" class="user-location mt-1">
                  <i class="fas fa-map-marker-alt"></i> Phường Linh Trung, Tp Thủ Đức
                </div>
                <div id="profile-about" class="about-text">
                  Cuộc đời là một hành trình dài <br> mỗi bước đi đều là một bài học đáng giá..
                </div>
              </div>
                ...
                <div class="modal-body">
                  <form id="profile-edit-form">
                    ...
                    <div class="form-group">
                      ...
                      <textarea id="edit-profile-about" class="form-control" rows="3">Cuộc đời là một hành trình dài mỗi bước đi đều là một bài học đáng giá..</textarea>
                    </div>
                  ...
                  <div class="card">
                    <div class="card-body">
                      ...
                      <div class="row mt-5">
                        ...
                        <p id="name-display" class="col-sm-9">Nguyễn Chí Sơn</p>
                      </div>
                      <div class="row">
                        <p class="col-sm-3 text-sm-right mb-0 mb-sm-3">Ngày sinh</p>
                        <p id="dob-display" class="col-sm-9">30/10/2004</p>
                      </div>
                      <div class="row">
                        <p class="col-sm-3 text-sm-right mb-0 mb-sm-3">Email</p>
                        <p id="email-display" class="col-sm-9">nguyenchison2004py@gmail.com</p>
                      </div>
                      <div class="row">
                        <p class="col-sm-3 text-sm-right mb-0 mb-sm-3">Số điện thoại</p>
                        <p id="phone-display" class="col-sm-9">0862-309-507</p>
                      </div>
                      <div class="row">
                        <p class="col-sm-3 text-sm-right mb-0">Địa chỉ</p>
                        <p id="address-display" class="col-sm-9 mb-0">
                          Đại Học Nông Lâm,<br> Phường Linh Trung,<br> Thành phố Thủ Đức,<br>
                          ...
                          <form id="edit-form">
                            ...
                            <div class="form-group">
                              ...
                              <input type="email" id="email-input" class="form-control"
                                     value="nguyenchison2004py@gmail.com">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                              <label>Địa chỉ</label>
                              <textarea id="address-input" class="form-control" rows="3">Đại Học Nông Lâm, Phường Linh Trung, Thành phố Thủ Đức, Thành phố Hồ Chí Minh</textarea>
                            </div>
                            <button type="button" class="btn btn-primary btn-block"
