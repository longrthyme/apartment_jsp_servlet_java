...
<html lang="en">
  <head>
    ...
    <link
      ...
      rel="stylesheet"
    />
    <link rel="stylesheet" href="User/css/tindaluu.css" />
  ...
  <body>
      ...
      <div class="container">
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
          ...
          <a class="navbar-brand" href="User/html/home.html">
            <img src="User/images/LoGo.jpg" style="width: 50px; height: 50px" />
            ...
            <ul class="navbar-nav ms-auto">
              ...
              <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu" aria-labelledby="thueDropdown">
                  <li>
                    <a class="dropdown-item" href="#">Thuê căn hộ chung cư</a>
                  </li>
                  <li>
              ...
              <li class="nav-item">
                <a class="nav-link" href="User/html/tindaluu.html"
    ...
    <div class="container mt-4">
      <h1 class="text-center mb-4">Tin Đã Lưu</h1>

      <!-- Danh sách bất động sản -->
      <h3 class="mb-4">Danh sách bất động sản</h3>
      <div class="row" id="saved-posts">
        <!-- Card 1 -->
        <div class="col-md-4 mb-4">
          <div class="card shadow-sm h-100">
            <img
              src="User/images/hst4.jpg"
              class="card-img-top"
              alt="Căn hộ Eco Green"
            />
            <div class="card-body">
              <h5 class="card-title">Căn hộ Eco Green</h5>
              <p class="card-text"><strong>Giá:</strong> 14 triệu/tháng</p>
              <p class="card-text"><strong>Diện tích:</strong> 65 m²</p>
              <p class="card-text"><strong>Vị trí:</strong> Quận 7, TP. HCM</p>
        ...
        <div class="col-md-4 mb-4">
          <div class="card shadow-sm h-100">
            <img
              src="User/images/vh2.jpg"
              class="card-img-top"
              alt="Căn hộ Sunrise City"
            />
            <div class="card-body">
              <h5 class="card-title">Căn hộ Sunrise City</h5>
              <p class="card-text"><strong>Giá:</strong> 18 triệu/tháng</p>
              <p class="card-text"><strong>Diện tích:</strong> 75 m²</p>
              <p class="card-text"><strong>Vị trí:</strong> Quận 7, TP. HCM</p>
              <button class="btn btn-danger btn-sm btn-delete">
                <i class="fas fa-trash-alt"></i> Xóa
              </button>
        ...
        <div class="col-md-4 mb-4">
          <div class="card shadow-sm h-100">
            <img
              src="User/images/vh4.jpg"
              class="card-img-top"
              alt="Căn hộ Sky Garden"
            />
            <div class="card-body">
              <h5 class="card-title">Căn hộ Sky Garden</h5>
              <p class="card-text"><strong>Giá:</strong> 20 triệu/tháng</p>
              <p class="card-text"><strong>Diện tích:</strong> 85 m²</p>
              <p class="card-text"><strong>Vị trí:</strong> Quận 7, TP. HCM</p>
    ...
    <footer class="footer">
      ...
      <div class="footer-section bottom">
        ...
        <img
          src="User/images/registered-icon.jpg"
          alt="Registered"
          class="social-icon"
          style="width: 100px; height: 40px"
        />
        <div class="social-icons">
          <img src="User/images/f" alt="Facebook" class="social-icon" />
          <img
            src="User/images/youtube-icon.jpg"
            alt="YouTube"
            class="social-icon"
          />
          <img
            src="User/images/zalo-icon.jpg"
            alt="Facebook"
            class="social-icon"
          />
        </div>
    ...
    <script src="User/js/tindaluu.js"></script>
